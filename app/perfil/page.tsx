  ...
  return (
    <div className="mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-10 pb-10 border-b border-[var(--color-border)] dark:border-[var(--color-border-dark)]">
        <div className="flex items-center gap-5">
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-tr from-[var(--color-brand)] to-[#4f46e5] dark:from-[var(--color-brand-dark)] dark:to-[#818cf8] flex items-center justify-center flex-shrink-0 shadow-md">
            <img src="/perfil.jpeg" alt="Profile" className="w-20 h-20 rounded-2xl" />
          </div>
          <div>
      ...
      <section className="mb-12">
        ...
        <div className="group relative overflow-hidden rounded-2xl border border-[var(--color-border)] dark:border-[var(--color-border-dark)] bg-[var(--color-surface)] dark:bg-[var(--color-surface-dark)] p-6 transition-all duration-300 hover:shadow-md hover:-translate-y-1">
          <div className="flex items-start justify-between gap-4 mb-3">
            <div>
              ...
              <h3 className="font-display text-lg font-bold text-[var(--color-ink)] dark:text-[var(--color-ink-dark)]">
                Aetheria Core — Gateway de Ingestão de Logs
              </h3>
            </div>
          </div>
          <p className="text-sm text-[var(--color-muted)] dark:text-[var(--color-muted-dark)] leading-relaxed mb-4">
            Uma plataforma de alta performance desenvolvida para consolidação e ingestão de logs distribuídos. Utiliza filas assíncronas para garantir entrega sem perdas e resiliência sob picos de tráfego de até 12.000 requisições por segundo.
          </p>
          <div className="flex flex-wrap gap-2 mb-4">
            {["Node.js", "NestJS", "TypeScript", "RabbitMQ", "Docker"].map((tech) => (
